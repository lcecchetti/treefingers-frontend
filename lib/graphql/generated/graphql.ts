...
export type StoryCard_StoryFragment = { __typename: 'Story', id: string, title: string, excerpt: string, createdAt: string, depth: number, tags: Array<string>, likesCount: number, commentsCount: number, descendentsCount: number, childrenCount: number, parent: { id: string, likesCount: number, descendentsCount: number } | null, author: { id: string, username: string }, currentUserLike: { id: string } | null } & { ' $fragmentName'?: 'StoryCard_StoryFragment' };

export type StoryContent_StoryFragment = { __typename: 'Story', id: string, title: string, content: string, excerpt: string, createdAt: string, tags: Array<string>, likesCount: number, commentsCount: number, descendentsCount: number, childrenCount: number, depth: number, isEditable: boolean, author: { id: string, username: string }, parent: { id: string } | null, root: { id: string, title: string, likesCount: number, descendentsCount: number, childrenCount: number, commentsCount: number, depth: number } | null, forest: { id: string, name: string } | null, currentUserLike: { id: string } | null } & { ' $fragmentName'?: 'StoryContent_StoryFragment' };
