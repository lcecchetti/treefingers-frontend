...
export type StoriesQuery = { stories: { edges: Array<{ cursor: string, node: { __typename: 'Story', id: string, title: string, excerpt: string, createdAt: string, depth: number, tags: Array<string>, likesCount: number, commentsCount: number, descendentsCount: number, parent: { id: string, likesCount: number, descendentsCount: number } | null, author: { id: string, username: string }, currentUserLike: { id: string } | null } }> | null, pageInfo: { hasNextPage: boolean, endCursor: string | null, totalCount: number } } };
...
export type StoryQuery = { story: { __typename: 'Story', id: string, title: string, content: string, excerpt: string, createdAt: string, tags: Array<string>, likesCount: number, commentsCount: number, descendentsCount: number, childrenCount: number, isEditable: boolean, author: { id: string, username: string }, parent: { id: string } | null, root: { id: string, title: string, likesCount: number, descendentsCount: number } | null, forest: { id: string, name: string } | null, currentUserLike: { id: string } | null } | null };
